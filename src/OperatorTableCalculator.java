...
public class OperatorTableCalculator {
    public static void main(String[] args) {
        ...
        String quotientText = canDivide ? String.valueOf(first / second) : "ArithmeticException";
        String remainderText = canDivide ? String.valueOf(first % second) : "ArithmeticException";
